...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
	$idAtualizar = test_input($_POST["idAtualizar"]);
  	$artistaAtualizar = test_input($_POST["artistaAtualizar"]);
}else{
...
<!-- deletar artista -->
<?php
$sql = "update artistas SET artista='" . $artistaAtualizar . "' WHERE indice='" . $idAtualizar . "'";
$respostaSql = "";
if ($conn->query($sql) === TRUE) {
	$respostaSql = "Artista atualizado";
} else {
